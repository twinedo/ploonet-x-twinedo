...
const RegularProduction = () => {
  ...
  return (
    <div className="flex flex-col max-w-[780px] max-h-[816px] rounded-[20px] border bg-[#141414] md:px-[93px] md:py-[64px] jutify-center items-center">
      <div className="text-[44px] font-bold text-[#D9D9D9]">일반 제작</div>
      <div className="text-2xl text-white mb-[18px]">
        제작 시작 후 5영업일 이내
      </div>
