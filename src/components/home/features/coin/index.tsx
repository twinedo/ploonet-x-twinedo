...
const Coin = (props: CoinProps) => {
  ...
  return (
    <div className="w-[85px] h-[85px] md:w-[211px] md:h-[211px] rounded-full flex flex-col items-center justify-center relative bg-gradient-to-r from-[#FF4E83] to-[#FFBB54]">
      <div className="bg-[#141414] md:w-[210px] md:h-[210px] rounded-full flex flex-col items-center justify-center">
        <div className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF4E83] to-[#FFBB54] font-bold text-lg md:text-[32px] flex justify-center items-center">
          {title}
        </div>
